"""Registry of named colors with CSS pre-loading."""
...
# All 148 CSS named colors (hex values).
...
class ColorRegistry(GenericRegistry[Color]):
    """Registry of named colors. Pre-loads all CSS named colors on init."""
    ...
    @overload
    def get_color(self, name: str, default: TDefault) -> Color | TDefault: ...

    def get_color(self, name: str, default: object = _SENTINEL) -> Color | object:
